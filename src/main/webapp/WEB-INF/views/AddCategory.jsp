...
<sform:input  path="categoryName" cssClass="formStyle" placeholder="Category Name" />
 <sform:input  path="categoryDiscription" cssClass="formStyle" placeholder="Category Description" />
 <sform:input  path="catergoryId" cssClass="formStyle" type="hidden" />
<br>
